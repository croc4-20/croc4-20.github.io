...
#       <div class="quote">“</div>
#       <blockquote>
#              Avant, le corps humain était ma préoccupation artistique, sa posture,
#         son cadrage, sa force. Aujourd’hui, ce sont les éléments naturels qui
#         m’inspirent, les rapports qu’ils entretiennent, leurs imbrications, leurs
#         mouvements, leurs lignes ou matières.
#       </blockquote>
    ...
    for slug, cfg in CATEGORIES.items():
        ...
        if images:
            ...
            preview_parts.append(
                f"""
<a
  class="work category-random-image"
  href="{slug}.html"
  data-category="{slug}"
>
